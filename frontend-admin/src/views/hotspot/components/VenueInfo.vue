      ...
      >
        ...
        <v-card-text class="text--primary">
          ...
          <el-form>
            <el-form-item label="Risk">
              <el-select v-model="venue.risk_display_name" class="filter-item" placeholder="Please select">
                <el-option v-for="item in risk_level" :key="item.key" :label="item.display_name" :value="item.key" />
              </el-select>
            </el-form-item>
          </el-form>
        </v-card-text>
        ...
        <v-card-actions>
          <v-btn
            color="orange"
            text
            @click="changeSelectVenueId(venue)"
          >
            Select
          </v-btn>
          ...
          <v-btn
            color="orange"
            text
            @click="handleChangeSelectableArea(venue)"
          >
            Modify
          </v-btn>
        </v-card-actions>
